...
const url = "http://localhost:9000/feed.txt"
...
TUF_ValueArrays = TUF_ValueText.split("\r\n"); 
 ...
 TUF_ValueObject.MODBUS["1-2: Flow Rate: "] = REAL4(TUF_ValueArray[1], TUF_ValueArray[2]); //REAL4
 TUF_ValueObject.MODBUS["3-4: Energy Flow Rate: "] = REAL4(TUF_ValueArray[3],  TUF_ValueArray[4]); //REAL4
 TUF_ValueObject.MODBUS["5-6: Velocity: "] = REAL4(TUF_ValueArray[5] , TUF_ValueArray[6]); //REAL4
 TUF_ValueObject.MODBUS["7-8: Fluid sound speed: "] = REAL4(TUF_ValueArray[7] , TUF_ValueArray[8]); //REAL4
 TUF_ValueObject.MODBUS["9-10: positive accumulator:"] = parseInt(TUF_ValueArray[9]) +  parseInt(TUF_ValueArray[10]); //LONG
 TUF_ValueObject.MODBUS["11-12: Positive decimal fraction: "] = REAL4(TUF_ValueArray[11], TUF_ValueArray[12]); //REAL4
 TUF_ValueObject.MODBUS["13-14: Negative accumulator: "] = parseInt(TUF_ValueArray[13]) - parseInt(TUF_ValueArray[14]); //LONG
 TUF_ValueObject.MODBUS["15-16: Negative decimal fraction: "] = REAL4(TUF_ValueArray[15], TUF_ValueArray[16]); //REAL4
 TUF_ValueObject.MODBUS["17-18: Positive energy accumulator: "] = parseInt(TUF_ValueArray[17]) + parseInt(TUF_ValueArray[18]); //LONG
 TUF_ValueObject.MODBUS["19-20: Positive energy decimal fraction: "] = REAL4(TUF_ValueArray[19], TUF_ValueArray[20]); //REAL4
 TUF_ValueObject.MODBUS["21-22: Negative energy accumulator: "] = parseInt(TUF_ValueArray[21]) - parseInt(TUF_ValueArray[22]); //LONG
 TUF_ValueObject.MODBUS["23-24: Negative energy decimal fraction:  "] = REAL4(TUF_ValueArray[23], TUF_ValueArray[24]); //REAL4
 TUF_ValueObject.MODBUS["25-26: Net Accumulator "] = parseInt(TUF_ValueArray[25]) + parseInt(TUF_ValueArray[26]); //LONG
 TUF_ValueObject.MODBUS["27-28: Net decimal fraction: "] = REAL4(TUF_ValueArray[27], TUF_ValueArray[28]); //REAL4 
 TUF_ValueObject.MODBUS["29-30: Net energy accumulator: "] = parseInt(TUF_ValueArray[29]) + parseInt(TUF_ValueArray[30]); //LONG
 TUF_ValueObject.MODBUS["31-32: Net energy decimal fraction: "] = REAL4(TUF_ValueArray[31], TUF_ValueArray[32]); //REAL4
 TUF_ValueObject.MODBUS["33-34: Temperature #1/inlet: "] = REAL4(TUF_ValueArray[33], TUF_ValueArray[34]); //REAL4
 TUF_ValueObject.MODBUS["35-36: Temperature #2/outlet: "] = REAL4(TUF_ValueArray[35], TUF_ValueArray[36]); //REAL4
 TUF_ValueObject.MODBUS["37-38: Analog input AI3: "] = REAL4(TUF_ValueArray[37] ,TUF_ValueArray[38]) ; //REAL4
 TUF_ValueObject.MODBUS["39-40: Analog input AI4: "] = REAL4(TUF_ValueArray[39] , TUF_ValueArray[40]) ; //REAL4
 TUF_ValueObject.MODBUS["41-42: Analog input AI5: "] = REAL4(TUF_ValueArray[41] , TUF_ValueArray[42]) ; //REAL4
 TUF_ValueObject.MODBUS["43-44: Current input at AI3: "] = REAL4(TUF_ValueArray[43],  TUF_ValueArray[44]); //REAL4
 TUF_ValueObject.MODBUS["45-46: Current input at AI3: "] = REAL4(TUF_ValueArray[45], TUF_ValueArray[46]) ; //REAL4
 TUF_ValueObject.MODBUS["47-48: Current input at AI3: "] = REAL4(TUF_ValueArray[47] , TUF_ValueArray[48]); //REAL4
 ...
 TUF_ValueObject.MODBUS["77-78: PT100 resistance of inlet: "] = REAL4(TUF_ValueArray[77] , TUF_ValueArray[78]); //REAL4
 TUF_ValueObject.MODBUS["79-80: PT100 resistance of outlet: "] = REAL4(TUF_ValueArray[79], TUF_ValueArray[80]); //REAL4
 TUF_ValueObject.MODBUS["81-82: Total travel time: "] = REAL4(TUF_ValueArray[81],  TUF_ValueArray[82]); //REAL4
 TUF_ValueObject.MODBUS["83-84: Delta travel time: "] = REAL4(TUF_ValueArray[83], TUF_ValueArray[84]); //REAL4
 TUF_ValueObject.MODBUS["85-86: Upstream travel time: "] = REAL4(TUF_ValueArray[85], TUF_ValueArray[86]); //REAL4
 TUF_ValueObject.MODBUS["87-88: Downstream travel time: "] = REAL4(TUF_ValueArray[87],TUF_ValueArray[88]); //REAL4
 TUF_ValueObject.MODBUS["89-90: Output current: "] = REAL4(TUF_ValueArray[89], TUF_ValueArray[90]); //REAL4
 ...
 TUF_ValueObject.MODBUS["97-98: The rate of the measured travel: "] = REAL4(TUF_ValueArray[97], TUF_ValueArray[98]); //REAL4
 TUF_ValueObject.MODBUS["99-100: Reynolds number: "] = REAL4(TUF_ValueArray[99], TUF_ValueArray[100]); //REAL4
